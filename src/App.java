...
import Materia.Ejercicio_01_sign.Validacion;
...
public class App {
    public static void main(String[] args) throws Exception {
        ...
        public static void imprimirResultado(){
         boolean resultado = esValida(caracteres);
        System.out.println("La cadena \"" + caracteres + "\" es " + (resultado ? "válida" : "inválida"));
        ...
        // Validar cada cadena y imprimir el resultado
        for (String caracteres : caracteres) {
            imprimirResultado(caracteres);
        }
    }
}
